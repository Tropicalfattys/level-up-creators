...
DROP TRIGGER IF EXISTS notify_creator_payout_trigger ON public.payments;
DROP TRIGGER IF EXISTS notify_new_booking_message_trigger ON public.messages;
DROP TRIGGER IF EXISTS notify_new_direct_message_trigger ON public.direct_messages;
