...
-- Drop and recreate database functions to exclude avatar_url for performance
...
-- Recreate get_public_profile function without avatar_url
...
-- Recreate get_public_profile_by_handle function without avatar_url
...
-- Recreate get_public_creators function without avatar_url
