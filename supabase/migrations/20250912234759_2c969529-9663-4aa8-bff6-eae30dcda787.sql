-- Add support for rejected_by_creator booking status
-- Update booking status handling to support the new status

-- Update notification triggers to handle rejected bookings
