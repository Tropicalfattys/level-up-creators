...
-- Update the INSERT policy to be more restrictive by requiring the use of the secure function
...
-- Create a more restrictive policy that only allows inserts through our secure function
-- This is achieved by making the policy very restrictive for direct inserts
CREATE POLICY "Secure job application submission only" 
ON public.job_applications 
FOR INSERT 
WITH CHECK (false);

-- Note: The security definer function above will bypass RLS and handle the insert securely