          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-card border-border">
              <CardContent className="p-8 text-center">
                <img src="https://cpxqkiajkkeizsewhoel.supabase.co/storage/v1/object/public/Blockchain/Crypto-Native_Payments.png" alt="Crypto-Native Payments" className="h-14 w-14 mx-auto mb-4" />
            ...
            <Card className="bg-card border-border">
              <CardContent className="p-8 text-center">
                <img src="https://cpxqkiajkkeizsewhoel.supabase.co/storage/v1/object/public/Blockchain/Escrow___Security-removebg-preview.png" alt="Escrow & Security" className="h-14 w-14 mx-auto mb-4" />
            ...
            <Card className="bg-card border-border">
              <CardContent className="p-8 text-center">
                <img src="https://cpxqkiajkkeizsewhoel.supabase.co/storage/v1/object/public/Blockchain/Cross-Platform_Reach-removebg-preview.png" alt="Cross-Platform Reach" className="h-14 w-14 mx-auto mb-4" />
